...
#ifndef NAV2_TGMPPI_CONTROLLER__TOOLS__UTILS_HPP_
#define NAV2_TGMPPI_CONTROLLER__TOOLS__UTILS_HPP_
...
inline void savitskyGolayFilter(
  ...
  std::array<tgmppi::models::Control, 4> & control_history,
...
#endif  // NAV2_TGMPPI_CONTROLLER__TOOLS__UTILS_HPP_
