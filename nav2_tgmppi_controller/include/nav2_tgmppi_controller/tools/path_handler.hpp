...
#ifndef NAV2_TGMPPI_CONTROLLER__TOOLS__PATH_HANDLER_HPP_
#define NAV2_TGMPPI_CONTROLLER__TOOLS__PATH_HANDLER_HPP_
...
public:
  /**
    * @brief Constructor for tgmppi::PathHandler
    */
  PathHandler() = default;

  /**
    * @brief Destructor for tgmppi::PathHandler
    */
  ~PathHandler() = default;
...
#endif  // NAV2_TGMPPI_CONTROLLER__TOOLS__PATH_HANDLER_HPP_
