...
#ifndef NAV2_TGMPPI_CONTROLLER__TOOLS__NOISE_GENERATOR_HPP_
#define NAV2_TGMPPI_CONTROLLER__TOOLS__NOISE_GENERATOR_HPP_
...
public:
  /**
    * @brief Constructor for tgmppi::NoiseGenerator
    */
   ...
   */
  void initialize(
    tgmppi::models::OptimizerSettings & settings,
   ...
   * @param is_holonomic If base is holonomic
   */
  void reset(tgmppi::models::OptimizerSettings & settings, bool is_holonomic);
...
protected:
  ...
  tgmppi::models::OptimizerSettings settings_;
  bool is_holonomic_;
...
#endif  // NAV2_TGMPPI_CONTROLLER__TOOLS__NOISE_GENERATOR_HPP_
