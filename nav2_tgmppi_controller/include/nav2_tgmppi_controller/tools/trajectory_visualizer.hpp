...
#ifndef NAV2_TGMPPI_CONTROLLER__TOOLS__TRAJECTORY_VISUALIZER_HPP_
#define NAV2_TGMPPI_CONTROLLER__TOOLS__TRAJECTORY_VISUALIZER_HPP_
...
/**
 * @class tgmppi::TrajectoryVisualizer
...
public:
  /**
    * @brief Constructor for tgmppi::TrajectoryVisualizer
    */
...
protected:
  ...
  size_t time_step_{0};
  size_t publish_every_n_{1};
  size_t visualization_cycle_{0};
...
#endif  // NAV2_TGMPPI_CONTROLLER__TOOLS__TRAJECTORY_VISUALIZER_HPP_
