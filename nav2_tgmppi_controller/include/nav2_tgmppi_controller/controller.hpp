...
#ifndef NAV2_TGMPPI_CONTROLLER__CONTROLLER_HPP_
#define NAV2_TGMPPI_CONTROLLER__CONTROLLER_HPP_

#include <string>
#include <memory>

#include "nav2_tgmppi_controller/tools/path_handler.hpp"
...
using namespace tgmppi;  // NOLINT

/**
 * @class tgmppi::TgMppiController
 * @brief Main plugin controller for MPPI Controller
 */
class TgMppiController : public nav2_core::Controller
{
public:
  /**
    * @brief Constructor for tgmppi::TgMppiController
    */
  TgMppiController() = default;
...
#endif  // NAV2_TGMPPI_CONTROLLER__CONTROLLER_HPP_
