...
#ifndef NAV2_TGMPPI_CONTROLLER__CRITIC_FUNCTION_HPP_
#define NAV2_TGMPPI_CONTROLLER__CRITIC_FUNCTION_HPP_
...
/**
 * @class tgmppi::critics::CollisionCost
...
/**
 * @class tgmppi::critics::CriticFunction
...
public:
  /**
    * @brief Constructor for tgmppi::critics::CriticFunction
    */
  CriticFunction() = default;

  /**
    * @brief Destructor for tgmppi::critics::CriticFunction
    */
...
#endif  // NAV2_TGMPPI_CONTROLLER__CRITIC_FUNCTION_HPP_
