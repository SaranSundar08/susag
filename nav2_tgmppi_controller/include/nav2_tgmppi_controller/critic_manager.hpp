...
#ifndef NAV2_TGMPPI_CONTROLLER__CRITIC_MANAGER_HPP_
#define NAV2_TGMPPI_CONTROLLER__CRITIC_MANAGER_HPP_
...
public:
  /**
    * @brief Constructor for tgmppi::CriticManager
    */
  CriticManager() = default;

  /**
    * @brief Virtual Destructor for tgmppi::CriticManager
    */
...
#endif  // NAV2_TGMPPI_CONTROLLER__CRITIC_MANAGER_HPP_
