...
#ifndef NAV2_TGMPPI_CONTROLLER__MOTION_MODELS_HPP_
#define NAV2_TGMPPI_CONTROLLER__MOTION_MODELS_HPP_

#include <cstdint>
#include <string>

#include "nav2_tgmppi_controller/models/control_sequence.hpp"
...
public:
  /**
    * @brief Constructor for tgmppi::MotionModel
    */
  MotionModel() = default;

  /**
    * @brief Destructor for tgmppi::MotionModel
    */
...
/**
 * @class tgmppi::AckermannMotionModel
...
public:
  /**
    * @brief Constructor for tgmppi::AckermannMotionModel
    */
...
/**
 * @class tgmppi::DiffDriveMotionModel
...
public:
  /**
    * @brief Constructor for tgmppi::DiffDriveMotionModel
    */
...
public:
  /**
    * @brief Constructor for tgmppi::OmniMotionModel
    */
...
#endif  // NAV2_TGMPPI_CONTROLLER__MOTION_MODELS_HPP_
