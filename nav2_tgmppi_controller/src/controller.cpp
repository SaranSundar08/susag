...
#include <stdint.h>
#include <chrono>
#include "nav2_tgmppi_controller/controller.hpp"
#include "nav2_tgmppi_controller/tools/utils.hpp"

// #define BENCHMARK_TESTING

namespace nav2_tgmppi_controller
{

void TgMppiController::configure(
...
void TgMppiController::activate()
{
...
void TgMppiController::deactivate()
{
  trajectory_visualizer_.on_deactivate();
  RCLCPP_INFO(logger_, "Deactivated MPPI Controller: %s", name_.c_str());
}

void TgMppiController::reset()
{
  optimizer_.reset();
}

geometry_msgs::msg::TwistStamped TgMppiController::computeVelocityCommands(
...
void TgMppiController::visualize(nav_msgs::msg::Path transformed_plan)
{
...
void TgMppiController::setPlan(const nav_msgs::msg::Path & path)
{
  path_handler_.setPath(path);
}

void TgMppiController::setSpeedLimit(const double & speed_limit, const bool & percentage)
{
...
PLUGINLIB_EXPORT_CLASS(nav2_tgmppi_controller::TgMppiController, nav2_core::Controller)
