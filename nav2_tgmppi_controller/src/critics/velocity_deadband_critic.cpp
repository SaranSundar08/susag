...
#include "nav2_tgmppi_controller/critics/velocity_deadband_critic.hpp"
...
PLUGINLIB_EXPORT_CLASS(tgmppi::critics::VelocityDeadbandCritic, tgmppi::critics::CriticFunction)
