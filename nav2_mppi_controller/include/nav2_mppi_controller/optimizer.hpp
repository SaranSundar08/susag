...
protected:
   ...
   * ancillary command (mean shift), reusing their existing noise.
   */
  void applyBiasedControls();
...
protected:
  ...
  float ancillary_vx_{0.0f};   // Biased-MPPI: pursuit ancillary forward command
  float ancillary_wz_{0.0f};   // Biased-MPPI: pursuit ancillary yaw-rate command
