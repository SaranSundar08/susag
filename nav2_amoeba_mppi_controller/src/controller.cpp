...
#include <stdint.h>
#include <chrono>
#include "nav2_amoeba_mppi_controller/controller.hpp"
#include "nav2_amoeba_mppi_controller/tools/utils.hpp"

// #define BENCHMARK_TESTING

namespace nav2_amoeba_mppi_controller
{

void AmoebaController::configure(
...
void AmoebaController::activate()
{
...
void AmoebaController::deactivate()
{
  trajectory_visualizer_.on_deactivate();
  RCLCPP_INFO(logger_, "Deactivated MPPI Controller: %s", name_.c_str());
}

void AmoebaController::reset()
{
  optimizer_.reset();
}

geometry_msgs::msg::TwistStamped AmoebaController::computeVelocityCommands(
...
void AmoebaController::visualize(nav_msgs::msg::Path transformed_plan)
{
...
void AmoebaController::setPlan(const nav_msgs::msg::Path & path)
{
  path_handler_.setPath(path);
}

void AmoebaController::setSpeedLimit(const double & speed_limit, const bool & percentage)
{
...
PLUGINLIB_EXPORT_CLASS(nav2_amoeba_mppi_controller::AmoebaController, nav2_core::Controller)
