...
#include "nav2_amoeba_mppi_controller/critics/velocity_deadband_critic.hpp"
...
PLUGINLIB_EXPORT_CLASS(amoeba::critics::VelocityDeadbandCritic, amoeba::critics::CriticFunction)
