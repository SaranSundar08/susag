...
#ifndef NAV2_AMOEBA_MPPI_CONTROLLER__CRITIC_MANAGER_HPP_
#define NAV2_AMOEBA_MPPI_CONTROLLER__CRITIC_MANAGER_HPP_
...
#include "nav2_amoeba_mppi_controller/critic_function.hpp"

namespace amoeba
{

/**
 * @class amoeba::CriticManager
...
public:
  /**
    * @brief Constructor for amoeba::CriticManager
    */
  CriticManager() = default;

  /**
    * @brief Virtual Destructor for amoeba::CriticManager
    */
...
#endif  // NAV2_AMOEBA_MPPI_CONTROLLER__CRITIC_MANAGER_HPP_
