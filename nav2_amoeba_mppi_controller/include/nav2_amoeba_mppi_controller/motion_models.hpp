...
#ifndef NAV2_AMOEBA_MPPI_CONTROLLER__MOTION_MODELS_HPP_
#define NAV2_AMOEBA_MPPI_CONTROLLER__MOTION_MODELS_HPP_

#include <cstdint>
#include <string>

#include "nav2_amoeba_mppi_controller/models/control_sequence.hpp"
...
public:
  /**
    * @brief Constructor for amoeba::MotionModel
    */
  MotionModel() = default;

  /**
    * @brief Destructor for amoeba::MotionModel
    */
...
/**
 * @class amoeba::AckermannMotionModel
...
public:
  /**
    * @brief Constructor for amoeba::AckermannMotionModel
    */
...
/**
 * @class amoeba::DiffDriveMotionModel
...
public:
  /**
    * @brief Constructor for amoeba::DiffDriveMotionModel
    */
...
public:
  /**
    * @brief Constructor for amoeba::OmniMotionModel
    */
...
#endif  // NAV2_AMOEBA_MPPI_CONTROLLER__MOTION_MODELS_HPP_
