...
#ifndef NAV2_AMOEBA_MPPI_CONTROLLER__CRITIC_FUNCTION_HPP_
#define NAV2_AMOEBA_MPPI_CONTROLLER__CRITIC_FUNCTION_HPP_
...
#include "nav2_amoeba_mppi_controller/critic_data.hpp"

namespace amoeba::critics
{

/**
 * @class amoeba::critics::CollisionCost
...
/**
 * @class amoeba::critics::CriticFunction
...
public:
  /**
    * @brief Constructor for amoeba::critics::CriticFunction
    */
  CriticFunction() = default;

  /**
    * @brief Destructor for amoeba::critics::CriticFunction
    */
...
#endif  // NAV2_AMOEBA_MPPI_CONTROLLER__CRITIC_FUNCTION_HPP_
