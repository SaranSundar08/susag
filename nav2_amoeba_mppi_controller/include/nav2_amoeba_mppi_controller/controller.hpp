...
#ifndef NAV2_AMOEBA_MPPI_CONTROLLER__CONTROLLER_HPP_
#define NAV2_AMOEBA_MPPI_CONTROLLER__CONTROLLER_HPP_

#include <string>
#include <memory>

#include "nav2_amoeba_mppi_controller/tools/path_handler.hpp"
#include "nav2_amoeba_mppi_controller/optimizer.hpp"
#include "nav2_amoeba_mppi_controller/tools/trajectory_visualizer.hpp"
...
using namespace amoeba;  // NOLINT

/**
 * @class amoeba::AmoebaController
 * @brief Main plugin controller for MPPI Controller
 */
class AmoebaController : public nav2_core::Controller
{
public:
  /**
    * @brief Constructor for amoeba::AmoebaController
    */
  AmoebaController() = default;
...
#endif  // NAV2_AMOEBA_MPPI_CONTROLLER__CONTROLLER_HPP_
