...
#ifndef NAV2_AMOEBA_MPPI_CONTROLLER__TOOLS__NOISE_GENERATOR_HPP_
#define NAV2_AMOEBA_MPPI_CONTROLLER__TOOLS__NOISE_GENERATOR_HPP_
...
public:
  /**
    * @brief Constructor for amoeba::NoiseGenerator
    */
   ...
   */
  void initialize(
    amoeba::models::OptimizerSettings & settings,
   ...
   * @param is_holonomic If base is holonomic
   */
  void reset(amoeba::models::OptimizerSettings & settings, bool is_holonomic);
...
protected:
  ...
  amoeba::models::OptimizerSettings settings_;
  bool is_holonomic_;
...
#endif  // NAV2_AMOEBA_MPPI_CONTROLLER__TOOLS__NOISE_GENERATOR_HPP_
