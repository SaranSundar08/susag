...
#ifndef NAV2_AMOEBA_MPPI_CONTROLLER__TOOLS__PATH_HANDLER_HPP_
#define NAV2_AMOEBA_MPPI_CONTROLLER__TOOLS__PATH_HANDLER_HPP_
...
public:
  /**
    * @brief Constructor for amoeba::PathHandler
    */
  PathHandler() = default;

  /**
    * @brief Destructor for amoeba::PathHandler
    */
  ~PathHandler() = default;
...
#endif  // NAV2_AMOEBA_MPPI_CONTROLLER__TOOLS__PATH_HANDLER_HPP_
