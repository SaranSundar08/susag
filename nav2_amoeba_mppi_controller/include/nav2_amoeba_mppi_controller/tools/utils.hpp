...
#ifndef NAV2_AMOEBA_MPPI_CONTROLLER__TOOLS__UTILS_HPP_
#define NAV2_AMOEBA_MPPI_CONTROLLER__TOOLS__UTILS_HPP_
...
inline void savitskyGolayFilter(
  ...
  std::array<amoeba::models::Control, 4> & control_history,
...
#endif  // NAV2_AMOEBA_MPPI_CONTROLLER__TOOLS__UTILS_HPP_
